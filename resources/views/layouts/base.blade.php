...
<body class="home-page home-01 ">
									...
									@auth
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												<a title="Tài khoản của tôi" href="#">Tài khoản của tôi ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Dashboard" href="{{route('admin.dashboard')}}">Bảng điều khiển</a>
													</li>
													<li class="menu-item">
														<a title="Categories" href="{{route('admin.categories')}}">Danh mục</a>
													</li>
													<li class="menu-item">
														<a title="Products" href="{{route('admin.products')}}">Sách</a>
													</li>
													<li class="menu-item">
														<a title="Manage Home Slider" href="{{route('admin.homeslider')}}">Quản lý home slide </a>
													</li>
													<li class="menu-item">
														<a title="Manage Home Categories" href="{{route('admin.homecategories')}}">Quản lý danh mục trang chủ</a>
													</li>

													<li class="menu-item">
														<a title="Sale Setting" href="{{route('admin.sale')}}">Cài đặt giảm giá</a>
													</li>
													<li class="menu-item">
										...
										@else
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Dashboard" href="{{route('user.dashboard')}}">Bảng điều khiển</a>
													</li>
													<li class="menu-item">
														<a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
													</li>
										...
										@endif
									@else
										<li class="menu-item" ><a title="Đăng nhập" href="{{route('login')}}">Đăng nhập</a></li>
										<li class="menu-item" ><a title="Đăng ký" href="{{route('register')}}">Đăng ký</a></li>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{asset('assets/images/hedspi13.jpg')}}" alt="hedspi"></a>
						</div>
						...
						<div class="wrap-icon right-section">
							...
							<div class="wrap-icon-section minicart">
								<a href="#" class="link-direction">
									...
									<div class="left-info">
										@if(Cart::count() >0)
										<span class="index">{{Cart::count()}} sản phẩm</span>
										@endif
					...
					<div class="header-nav-section">
						<div class="container">
							<ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info" >
								...
								<li class="menu-item"><a href="#" class="link-term">Mới nhất</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Bán chạy nhất</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Được đánh giá cao</a><span class="nav-label hot-label">hot</span></li>
							</ul>
						</div>
					</div>
	...
	<footer id="footer">
		<div class="wrap-footer-content footer-style-1">
					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Miễn cho đơn hàng lớn hơn 99$</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">An toàn cho thanh toán của bạn</p>
							</div>
			...
			<div class="main-footer-content">
				...
				<div class="container">
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">232 phố Kẻ Vẽ, phường Thụy Phương, quận Bắc Từ Liêm, Hà Nội</p>
											</li>
											<li>
											...
											<li>
												...
												<p class="contact-txt">nguyen.manh.truong-b@sun-asterisk.com</p>
											</li>											
										</ul>
									</div>
								</div>
									...
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												...
												<li class="menu-item"><a href="#" class="link-term">Nhãn hiệu</a></li>
												<li class="menu-item"><a href="#" class="link-term">Phiếu giảm giá</a></li>
												<!-- <li class="menu-item"><a href="#" class="link-term">Affiliates</a></li> -->
												<li class="menu-item"><a href="#" class="link-term">Đã thích</a></li>
											</ul>
										</div>
									</div>
								</div>
									...
									<div class="item-content">
										<div class="wrap-vertical-nav">
											<ul>
												...
												<li class="menu-item"><a href="#" class="link-term">Bản đồ</a></li>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Hình thức thanh toán an toàn</h3>
								<div class="item-content">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Tải xuống ứng dụng</h3>
								<div class="item-content">
			...
			<div class="coppy-right-box mt-14px">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Bản quyền © 2022 Hedspi. Đã đăng ký bản quyền</p>
					</div>
