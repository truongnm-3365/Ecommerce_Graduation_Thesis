									...
									@auth
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Bảng điều khiển" href="{{route('admin.dashboard')}}">Bảng điều khiển</a>
													</li>
													<li class="menu-item">
										...
										@else
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Bảng điều khiển" href="{{route('user.dashboard')}}">Bảng điều khiển</a>
													</li>
													<li class="menu-item">
														<a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
													</li>
							...
							<div class="wrap-search-form">
								<form action="#" id="form-search-top" name="form-search-top">
									...
									<div class="wrap-list-cate">
										...
										<a href="#" class="link-control">Tất cả</a>
										<ul class="list-cate">
											<li class="level-0">Tất cả</li>
											<li class="level-1">-Sách luyện thi JLPT</li>
