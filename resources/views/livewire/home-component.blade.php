					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							<a href="{{route('product.details',['slug'=>$sproduct->slug])}}" title="{{$sproduct->name}}">
								<figure><img style="object-fit:cover!important" src="{{asset('assets/images/products/'.$sproduct->image)}}"  alt="{{$sproduct->name}}"></figure>
							</a>
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">${{$sproduct->sale_price}}</p></ins><del><p class="product-price">${{$sproduct->regular_price}}</span></p></div>
						</div>
					</div>
					@endforeach
